 ...
 */
public class ActivityOnayBekleyenSiparis extends AppCompatActivity {

    private Toolbar toolbar;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private static String LOG_TAG = "GTSSOnayBekleyenCardViewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onay_bekleyen_siparis);
        //TOOLBAR////
        ...
        ///TOOLBAR////
        if (Utilities.isNetworkAvailable(ActivityOnayBekleyenSiparis.this)) {
            if (Fonksiyonlar.giriskontrol(ActivityOnayBekleyenSiparis.this)) {
                Database database = new Database(ActivityOnayBekleyenSiparis.this);
            ...
            if (helperKulAdi != null || helperEmail != null) {
                getSupportActionBar().setTitle("Onay Bekleyen Siparişlerim");
                new RemoteDataTask().execute();
            } else {
                getSupportActionBar().setTitle("Veri Yok");
            }
        } else {
            Utilities.showAlertDialog(ActivityOnayBekleyenSiparis.this, getString(R.string.opps),
                    getString(R.string.check_network_connection),
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityOnayBekleyenSiparis.this.finish();
                        }
                    });
        }
        ...
        mLayoutManager = new GridLayoutManager(ActivityOnayBekleyenSiparis.this, 2);
    ...
    class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(ActivityOnayBekleyenSiparis.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            String json = post.httpPost(ConstantString.SIPARISLERIM_ONAY_BEKLEYEN_DOWNLOAD_URL, ConstantString.POST_METHOD, paramss, 20000);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (Integer.parseInt(sonuc) == 0) {
                Utilities.showAlertDialog(ActivityOnayBekleyenSiparis.this, "Bilgilendirme", "Siparişiniz Bulunmamaktadır.", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
            ...
            mAdapter = new SiparisRecyclerViewAdapter(getDataSet(), ActivityOnayBekleyenSiparis.this);
            ...
            ((SiparisRecyclerViewAdapter) mAdapter).setOnItemClickListener(new SiparisRecyclerViewAdapter
                ...
                public void onItemClick(int position, View v) {
                    Intent intent = new Intent(ActivityOnayBekleyenSiparis.this, Activity_Siparis_Detay.class);
