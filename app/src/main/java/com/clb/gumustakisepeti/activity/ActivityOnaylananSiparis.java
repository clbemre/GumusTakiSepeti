 ...
 */
public class ActivityOnaylananSiparis extends AppCompatActivity {

    private Toolbar toolbar;
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private static String LOG_TAG = "GTSSOnaylananCardViewActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onaylanan_siparis);
        //TOOLBAR////
        ...
        ///TOOLBAR////
        if (Utilities.isNetworkAvailable(ActivityOnaylananSiparis.this)) {
            if (Fonksiyonlar.giriskontrol(ActivityOnaylananSiparis.this)) {
                Database database = new Database(ActivityOnaylananSiparis.this);
            ...
            if (helperKulAdi != null || helperEmail != null) {
                getSupportActionBar().setTitle("Onaylanan Siparişlerim");
                new RemoteDataTask().execute();
            } else {
                getSupportActionBar().setTitle("Veri Yok");
            }
        } else {
            Utilities.showAlertDialog(ActivityOnaylananSiparis.this, getString(R.string.opps),
                    getString(R.string.check_network_connection),
                    new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityOnaylananSiparis.this.finish();
                        }
                    });
        }
        ...
        mLayoutManager = new GridLayoutManager(ActivityOnaylananSiparis.this, 2);
    ...
    class RemoteDataTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(ActivityOnaylananSiparis.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            String json = post.httpPost(ConstantString.SIPARISLERIM_ONAYLANAN_DOWNLOAD_URL, ConstantString.POST_METHOD, paramss, 20000);
        ...
        protected void onPostExecute(Void result) {
            ...
            if (Integer.parseInt(sonuc) == 0) {
                Utilities.showAlertDialog(ActivityOnaylananSiparis.this, "Bilgilendirme", "Siparişiniz Bulunmamaktadır.", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
            ...
            mAdapter = new SiparisRecyclerViewAdapter(getDataSet(), ActivityOnaylananSiparis.this);
            ...
            ((SiparisRecyclerViewAdapter) mAdapter).setOnItemClickListener(new SiparisRecyclerViewAdapter
                ...
                public void onItemClick(int position, View v) {
                    Intent intent = new Intent(ActivityOnaylananSiparis.this, Activity_Siparis_Detay.class);
